...
public class GPUImageView extends TiUIView implements OnLifecycleEvent, Handler.Callback
{
	...
	private GPUImageViewProxy imageViewProxy;
	...
	public GPUImageView(TiViewProxy proxy)
	{
		super(proxy);
		imageViewProxy = (GPUImageViewProxy) proxy;
